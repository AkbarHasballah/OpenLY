...
import {overlay,map,popupinfo,idmarker} from '../Model/config.js';
import {clickpopup} from '../View/template.js';
...
export function onSubmitMarkerClick() {
    ...
    postWithToken("","Token","dsf9ygf87h98u479y98dj0fs89nfd7",data,afterSubmitCOG);
    overlay.setPosition(undefined);
    textBlur('popup-closer');
